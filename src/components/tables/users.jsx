...
import { userTable } from "@/data/user-columns";
...
export default function TableUsers({ data = [], add, update, changeStatus }) {
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-wrap justify-center sm:justify-between gap-3 items-end">
          ...
          <div className="flex justify-center flex-wrap gap-3">
            <DropdownState
              setStatusFilter={(data) => setStatusFilter(data)}
